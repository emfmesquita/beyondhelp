...
const maps = [
    ...
    ], ["#Episode1GreenestinFlames", "#TheApproach", "#GeneralFeatures", "#ImportantCharacters", "#WanderingEncounters",
            "#Missions", "#TheSallyPort", "#DragonAttack", "#Prisoners", "#HalfDragonChampion"]),
    new MapInfo("hotdq/raiders-camp", "hotdq-02-03.jpg", "d2749d0d-8ce3-4e6a-99af-22b39fb68c78", [
        ...
        new MapAreaInfo("Episode3DragonHatchery", "754,378,784,408", "hotdq/dragon-hatchery", "9cc74f50-90b8-465c-ac7e-7dcff1297559")
    ], ["#Episode2RaidersCamp", "#CampAlertness", "#ExploringtheCamp", "#Rewards"]),
    new MapInfo("hotdq/dragon-hatchery", "episode-3-dragon-hatchery.jpg", "9cc74f50-90b8-465c-ac7e-7dcff1297559", [
        ...
        new MapAreaInfo("Episode2RaidersCamp", "15,208,64,382", "hotdq/raiders-camp", "d2749d0d-8ce3-4e6a-99af-22b39fb68c78")
    ], ["#Episode3DragonHatchery", "#GeneralFeatures", "#WanderingMonsters", "#Rewards"]),
    new MapInfo("hotdq/construction-ahead", "hotdq-05-02.jpg", "86120207-bb8c-428b-ae28-46c31b4af991", [
        ...
        new MapAreaInfo("7ArdredBriferhewsRoom", "692,95,730,146"),
        new MapAreaInfo("8Kitchen", "731,359,751,379")
    ], ["#CarnathRoadhouse", "#EssentialIngredients", "#TrackingtheLoad", "#GrudgeMatch"]),
    new MapInfo("hotdq/castle-naerytar", "episode-6-castle-naerytar-ground-level.jpg", "ae988e89-dfca-47fe-b641-8f0723717f37", [
        ...
        new MapAreaInfo("5Moat", "473,261,524,368"),
        new MapAreaInfo("5Moat", "396,403,480,450"),
        new MapAreaInfo("5Moat", "395,502,684,547"),
        new MapAreaInfo("5Moat", "741,153,798,338"),
        new MapAreaInfo("5Moat", "576,129,671,190"),
        new MapAreaInfo("5Moat", "246,362,313,412"),
        new MapAreaInfo("5Moat", "439,147,481,218"),
        new MapAreaInfo("5Moat", "483,124,532,157"),
        ...
        new MapAreaInfo("SecondFloor", "368,491,384,521", null, "7870944a-171c-476e-83c6-7bcedb3eabe9"),
        new MapAreaInfo("SecondFloor", "509,419,538,436", null, "7870944a-171c-476e-83c6-7bcedb3eabe9"),
        new MapAreaInfo("SecondFloor", "628,438,642,455", null, "7870944a-171c-476e-83c6-7bcedb3eabe9"),
        new MapAreaInfo("SecondFloor", "714,480,730,508", null, "7870944a-171c-476e-83c6-7bcedb3eabe9"),
        new MapAreaInfo("SecondFloor", "691,417,720,433", null, "7870944a-171c-476e-83c6-7bcedb3eabe9"),
        new MapAreaInfo("SecondFloor", "546,359,561,374", null, "7870944a-171c-476e-83c6-7bcedb3eabe9"),
        new MapAreaInfo("SecondFloor", "608,276,624,291", null, "7870944a-171c-476e-83c6-7bcedb3eabe9"),
        new MapAreaInfo("SecondFloor", "714,182,731,219", null, "7870944a-171c-476e-83c6-7bcedb3eabe9"),
        new MapAreaInfo("SecondFloor", "502,191,516,208", null, "7870944a-171c-476e-83c6-7bcedb3eabe9"),
        new MapAreaInfo("BeneaththeCastle", "517,191,531,208", null, "baf67204-9d06-43a6-950d-8d4a7e698ee7")
    ], ["#InsideCastleNaerytar", "#GroundFloor"]),
    new MapInfo("hotdq/castle-naerytar", "episode-6-castle-naerytar-upper-level-2.jpg", "7870944a-171c-476e-83c6-7bcedb3eabe9", [
        ...
        new MapAreaInfo("GroundFloor", "483,590,523,612", null, "ae988e89-dfca-47fe-b641-8f0723717f37"),
        new MapAreaInfo("GroundFloor", "420,228,443,251", null, "ae988e89-dfca-47fe-b641-8f0723717f37"),
        new MapAreaInfo("GroundFloor", "391,370,411,390", null, "ae988e89-dfca-47fe-b641-8f0723717f37"),
        new MapAreaInfo("GroundFloor", "386,127,406,147", null, "ae988e89-dfca-47fe-b641-8f0723717f37"),
        new MapAreaInfo("GroundFloor", "483,102,503,122", null, "ae988e89-dfca-47fe-b641-8f0723717f37"),
        new MapAreaInfo("GroundFloor", "72,405,92,425", null, "ae988e89-dfca-47fe-b641-8f0723717f37"),
        new MapAreaInfo("GroundFloor", "77,111,97,131", null, "ae988e89-dfca-47fe-b641-8f0723717f37"),
        new MapAreaInfo("GroundFloor", "301,352,311,362", null, "ae988e89-dfca-47fe-b641-8f0723717f37"),
        new MapAreaInfo("GroundFloor", "188,265,198,275", null, "ae988e89-dfca-47fe-b641-8f0723717f37"),
        new MapAreaInfo("ThirdFloor", "391,391,411,411", null, "d6aca5d2-d6e4-4eb7-ba29-6b007c309b5b"),
        new MapAreaInfo("ThirdFloor", "386,148,406,168", null, "d6aca5d2-d6e4-4eb7-ba29-6b007c309b5b"),
        new MapAreaInfo("ThirdFloor", "504,102,524,122", null, "d6aca5d2-d6e4-4eb7-ba29-6b007c309b5b"),
        new MapAreaInfo("ThirdFloor", "72,384,92,404", null, "d6aca5d2-d6e4-4eb7-ba29-6b007c309b5b"),
        new MapAreaInfo("ThirdFloor", "92,144,112,164", null, "d6aca5d2-d6e4-4eb7-ba29-6b007c309b5b"),
        new MapAreaInfo("ThirdFloor", "314,345,324,365", null, "d6aca5d2-d6e4-4eb7-ba29-6b007c309b5b"),
        new MapAreaInfo("ThirdFloor", "200,258,210,268", null, "d6aca5d2-d6e4-4eb7-ba29-6b007c309b5b")
    ]),
    new MapInfo("hotdq/castle-naerytar", "episode-6-castle-naerytar-upper-level-3.jpg", "d6aca5d2-d6e4-4eb7-ba29-6b007c309b5b", [
        ...
        new MapAreaInfo("SecondFloor", "391,370,411,410", null, "7870944a-171c-476e-83c6-7bcedb3eabe9"),
        new MapAreaInfo("SecondFloor", "303,344,323,364", null, "7870944a-171c-476e-83c6-7bcedb3eabe9"),
        new MapAreaInfo("SecondFloor", "482,115,522,135", null, "7870944a-171c-476e-83c6-7bcedb3eabe9"),
        new MapAreaInfo("SecondFloor", "386,126,406,166", null, "7870944a-171c-476e-83c6-7bcedb3eabe9"),
        new MapAreaInfo("SecondFloor", "190,258,210,278", null, "7870944a-171c-476e-83c6-7bcedb3eabe9"),
        new MapAreaInfo("SecondFloor", "72,385,92,425", null, "7870944a-171c-476e-83c6-7bcedb3eabe9"),
        new MapAreaInfo("SecondFloor", "85,111,105,161", null, "7870944a-171c-476e-83c6-7bcedb3eabe9")
    ]),
    new MapInfo("hotdq/castle-naerytar", "episode-6-castle-naerytar-dungeon.jpg", "baf67204-9d06-43a6-950d-8d4a7e698ee7", [
        ...
        new MapAreaInfo("GroundFloor", "605,345,665,365", null, "ae988e89-dfca-47fe-b641-8f0723717f37")
    ], ["#BeneaththeCastle", "#GeneralFeaturesoftheCave"]),
    new MapInfo("hotdq/hunting-lodge", "episode-7-hunting-lodge-ground-floor.jpg", "566a5d33-c3e7-40e4-9d89-b13c21b7657a", [
        ...
        new MapAreaInfo("9Basement", "117,192,189,215"),
        ...
        new MapAreaInfo("12KoboldServants", "511,122,550,215"),
        ...
        new MapAreaInfo("LodgeUpperFloor", "275,222,323,238", null, "f09cde5d-bbe0-49f2-9dcc-12080ec06e33"),
        new MapAreaInfo("LodgeUpperFloor", "140,122,166,145", null, "f09cde5d-bbe0-49f2-9dcc-12080ec06e33")
    ], ["#Episode7HuntingLodge", "#GeneralFeatures", "#OutsidetheLodge", "#OutdoorPatrol", "#TrollPursuit", "#1PortalStones"]),
    new MapInfo("hotdq/hunting-lodge", "episode-7-hunting-lodge-upper-floor.jpg", "f09cde5d-bbe0-49f2-9dcc-12080ec06e33", [
        ...
        new MapAreaInfo("LodgeGroundFloor", "275,325,359,355", null, "566a5d33-c3e7-40e4-9d89-b13c21b7657a"),
        new MapAreaInfo("LodgeGroundFloor", "164,220,219,246", null, "566a5d33-c3e7-40e4-9d89-b13c21b7657a"),
        new MapAreaInfo("LodgeGroundFloor", "711,78,791,103", null, "566a5d33-c3e7-40e4-9d89-b13c21b7657a")
    ], ["#22PerytonRoost"]),
    new MapInfo("hotdq/castle-in-the-clouds", "parnast-village.jpg", "7b575989-8204-4b54-9383-d651d4d421b9", [
    ...
    new MapInfo("hotdq/castle-in-the-clouds", "skyreach-castle.jpg", "86ce3b45-ab6f-4a35-ba5e-ab7a87c504b7", [
        ...
        new MapAreaInfo("9CultistBarracks", "323,723,413,758"),
